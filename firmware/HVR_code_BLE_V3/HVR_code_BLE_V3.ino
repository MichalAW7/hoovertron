...
void setup() {
  ...
  // Keep built-in LED on to increase current draw
  pinMode(LED_BUILTIN, OUTPUT);
  digitalWrite(LED_BUILTIN, HIGH);

  // Use D2 as a "dummy load" pin — attach a 100-220 ohm resistor from D2 to GND
  pinMode(2, OUTPUT);
...
void loop() {
  ...
  // Pulse dummy load pin to maintain current draw for battery pack
  digitalWrite(2, HIGH);
